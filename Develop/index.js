...
const newHTML = require("./generateHTML")
...
//dotenv? gitignore /users?client_id=my client id&client_secret=client secret
...
const userInput = function(){
    ...
    .then(function(res){
        ...
        //  gitProfile = this.html_url;
        //  userBlog = this.blog;
        // userBio = this.bio;
        //  repoNum = this.public_repos;
...
console.log(res);
    ...
    //   }).then(function(){
    //       console.log(img, location, gitProfile, userBlog, userBio, repoNum, followers, following);
...
//       // const test = await writeFileAsync("index2.html", newHTML);
